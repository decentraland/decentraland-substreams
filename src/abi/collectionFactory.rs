    ...
    pub mod functions {
        ...
        pub struct Code {}
        impl Code {
            const METHOD_ID: [u8; 4] = [36u8, 193u8, 43u8, 246u8];
            pub fn decode(
        ...
        impl substreams_ethereum::Function for Code {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Code {
        ...
        pub struct CodeHash {}
        impl CodeHash {
            const METHOD_ID: [u8; 4] = [24u8, 237u8, 170u8, 242u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for CodeHash {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for CodeHash {
        ...
        impl CreateCollection {
            const METHOD_ID: [u8; 4] = [157u8, 45u8, 57u8, 87u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
        ...
        impl substreams_ethereum::Function for CreateCollection {
            const NAME: &'static str = "createCollection";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CreateCollection {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl CreateProxy {
            const METHOD_ID: [u8; 4] = [210u8, 119u8, 220u8, 137u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl GetAddress {
            const METHOD_ID: [u8; 4] = [32u8, 208u8, 111u8, 249u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
    ...
    pub mod events {
        use super::INTERNAL_ERR;
        #[derive(Debug, Clone, PartialEq)]
        pub struct ImplementationChanged {
            pub implementation: Vec<u8>,
            pub code_hash: [u8; 32usize],
            pub code: Vec<u8>,
        }
        impl ImplementationChanged {
        ...
        impl substreams_ethereum::Event for ImplementationChanged {
            const NAME: &'static str = "ImplementationChanged";

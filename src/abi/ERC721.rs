    ...
    pub mod events {
        use super::INTERNAL_ERR;
        #[derive(Debug, Clone, PartialEq)]
        pub struct AddWearable {
            pub wearable_id_key: [u8; 32usize],
            pub wearable_id: String,
            pub max_issuance: substreams::scalar::BigInt,
        }
        impl AddWearable {
                ...
                Ok(Self {
                    wearable_id_key: {
                        ...
                        let v = ethabi::decode(
                            ...
                            .map_err(|e| {
                                format!(
                                    "unable to decode param 'wearable_id_key' from topic of type 'bytes32': {:?}",
                                    e
                                )
                            })?
                            .pop()
        ...
        impl substreams_ethereum::Event for AddWearable {
            const NAME: &'static str = "AddWearable";
        ...
        impl substreams_ethereum::Event for Transfer4 {
            const NAME: &'static str = "Transfer4";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(

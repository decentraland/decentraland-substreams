    ...
    pub mod functions {
        ...
        impl Erc721Received {
            const METHOD_ID: [u8; 4] = [236u8, 201u8, 140u8, 228u8];
            pub fn decode(
        ...
        impl substreams_ethereum::Function for Erc721Received {
            const NAME: &'static str = "ERC721_RECEIVED";
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 4usize]> for Erc721Received {
        ...
        impl Available {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::String(self.subdomain.clone())],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
        ...
        pub struct Base {}
        impl Base {
            const METHOD_ID: [u8; 4] = [80u8, 1u8, 243u8, 181u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Base {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Base {
        ...
        pub struct Domain {}
        impl Domain {
            const METHOD_ID: [u8; 4] = [194u8, 251u8, 38u8, 166u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Domain {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<String> for Domain {
            fn output(data: &[u8]) -> Result<String, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct DomainNameHash {}
        impl DomainNameHash {
            const METHOD_ID: [u8; 4] = [202u8, 83u8, 219u8, 157u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for DomainNameHash {
            const NAME: &'static str = "domainNameHash";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for DomainNameHash {
            fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct ForwardToResolver {
            pub data: Vec<u8>,
        }
        impl ForwardToResolver {
            const METHOD_ID: [u8; 4] = [194u8, 143u8, 72u8, 206u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ForwardToResolver {
            const NAME: &'static str = "forwardToResolver";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetOwnerOf {
            pub subdomain: String,
        }
        impl GetOwnerOf {
            const METHOD_ID: [u8; 4] = [190u8, 244u8, 141u8, 223u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetOwnerOf {
            const NAME: &'static str = "getOwnerOf";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetOwnerOf {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl GetTokenId {
            const METHOD_ID: [u8; 4] = [30u8, 118u8, 99u8, 188u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        pub struct MigrateNames {
            pub names: Vec<[u8; 32usize]>,
            pub beneficiaries: Vec<Vec<u8>>,
            pub created_dates: Vec<substreams::scalar::BigInt>,
        }
        impl MigrateNames {
            const METHOD_ID: [u8; 4] = [91u8, 129u8, 235u8, 136u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for MigrateNames {
            const NAME: &'static str = "migrateNames";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct Migrated {}
        impl Migrated {
            const METHOD_ID: [u8; 4] = [44u8, 103u8, 140u8, 100u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Migrated {
            const NAME: &'static str = "migrated";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for Migrated {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        impl MigrationFinished {
            const METHOD_ID: [u8; 4] = [63u8, 158u8, 35u8, 229u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for MigrationFinished {
            const NAME: &'static str = "migrationFinished";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::Function for Reclaim1 {
            const NAME: &'static str = "reclaim1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Reclaim2 {
            const METHOD_ID: [u8; 4] = [45u8, 171u8, 190u8, 237u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for Reclaim2 {
            const NAME: &'static str = "reclaim2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl ReclaimDomain {
            const METHOD_ID: [u8; 4] = [57u8, 139u8, 147u8, 209u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ReclaimDomain {
            const NAME: &'static str = "reclaimDomain";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Register {
            const METHOD_ID: [u8; 4] = [30u8, 89u8, 197u8, 41u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl Subdomains {
            const METHOD_ID: [u8; 4] = [157u8, 121u8, 208u8, 129u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for Subdomains {
            const NAME: &'static str = "subdomains";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<String> for Subdomains {
            fn output(data: &[u8]) -> Result<String, String> {
                Self::output(data)
            }
        }
        ...
        impl Topdomain {
            const METHOD_ID: [u8; 4] = [36u8, 240u8, 147u8, 164u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Topdomain {
            const NAME: &'static str = "topdomain";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<String> for Topdomain {
            fn output(data: &[u8]) -> Result<String, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct TopdomainNameHash {}
        impl TopdomainNameHash {
            const METHOD_ID: [u8; 4] = [55u8, 119u8, 209u8, 89u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TopdomainNameHash {
            const NAME: &'static str = "topdomainNameHash";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TransferDomainOwnership {
            pub owner: Vec<u8>,
            pub token_id: substreams::scalar::BigInt,
        }
        impl TransferDomainOwnership {
            const METHOD_ID: [u8; 4] = [17u8, 73u8, 139u8, 70u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for TransferDomainOwnership {
            const NAME: &'static str = "transferDomainOwnership";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl UpdateBase {
            const METHOD_ID: [u8; 4] = [207u8, 95u8, 254u8, 186u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for UpdateBase {
            const NAME: &'static str = "updateBase";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpdateBaseUri {
            pub base_uri: String,
        }
        impl UpdateBaseUri {
            const METHOD_ID: [u8; 4] = [147u8, 22u8, 136u8, 203u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for UpdateBaseUri {
            const NAME: &'static str = "updateBaseURI";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl UpdateRegistry {
            const METHOD_ID: [u8; 4] = [26u8, 93u8, 166u8, 200u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
    ...
    pub mod events {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct BaseUpdated {
            pub previous_base: Vec<u8>,
            pub new_base: Vec<u8>,
        }
        impl BaseUpdated {
            const TOPIC_ID: [u8; 32] = [
            ...
            pub fn decode(
                ...
                Ok(Self {
                    previous_base: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[1usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'previous_base' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
                        ...
                        .as_bytes()
                        .to_vec(),
                    new_base: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[2usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'new_base' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
        ...
        impl substreams_ethereum::Event for BaseUpdated {
            const NAME: &'static str = "BaseUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct CallForwarwedToResolver {
            pub resolver: Vec<u8>,
            pub data: Vec<u8>,
            pub res: Vec<u8>,
        }
        impl CallForwarwedToResolver {
            const TOPIC_ID: [u8; 32] = [
                58u8,
                50u8,
                26u8,
        ...
        impl substreams_ethereum::Event for CallForwarwedToResolver {
            const NAME: &'static str = "CallForwarwedToResolver";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct DomainReclaimed {
            pub token_id: substreams::scalar::BigInt,
        }
        impl DomainReclaimed {
            const TOPIC_ID: [u8; 32] = [
                58u8,
                17u8,
                216u8,
        ...
        impl substreams_ethereum::Event for DomainReclaimed {
            const NAME: &'static str = "DomainReclaimed";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for DomainTransferred {
            const NAME: &'static str = "DomainTransferred";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for MigrationFinished {
            const NAME: &'static str = "MigrationFinished";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
        ...
        pub struct NameRegistered {
            pub caller: Vec<u8>,
            pub beneficiary: Vec<u8>,
            pub label_hash: [u8; 32usize],
            pub subdomain: String,
            pub created_date: substreams::scalar::BigInt,
        }
        impl NameRegistered {
            const TOPIC_ID: [u8; 32] = [
                87u8,
                ...
                Ok(Self {
                    ...
                    label_hash: {
                        ...
                        let v = ethabi::decode(
                            ...
                            .map_err(|e| {
                                format!(
                                    "unable to decode param 'label_hash' from topic of type 'bytes32': {:?}",
                                    e
                                )
                            })?
                            .pop()
        ...
        impl substreams_ethereum::Event for Reclaimed {
            const NAME: &'static str = "Reclaimed";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for RegistryUpdated {
            const NAME: &'static str = "RegistryUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct ResolverUpdated {
            pub old_resolver: Vec<u8>,
            pub new_resolver: Vec<u8>,
        }
        impl ResolverUpdated {
            const TOPIC_ID: [u8; 32] = [
                132u8,
                184u8,
                61u8,
            ...
            pub fn decode(
                ...
                Ok(Self {
                    old_resolver: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[1usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'old_resolver' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
                        ...
                        .as_bytes()
                        .to_vec(),
                    new_resolver: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[2usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'new_resolver' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
        ...
        impl substreams_ethereum::Event for ResolverUpdated {
            const NAME: &'static str = "ResolverUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
